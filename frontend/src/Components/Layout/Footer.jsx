...
const Footer = () => {
  return (
      <footer className="bg-white dark:bg-gray-800">
        {/*// <!-- Newsletter Section -->*/}
          <div className="p-4 md:p-6 lg:p-8 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              <div className="mx-auto max-w-screen-xl">
                  <div className="flex flex-col md:flex-row items-center text-center lg:text-start justify-between gap-2 md:gap-4">
                      {/* Left Content */}
        ...
        <div className="p-4 md:p-8 lg:p-10">
          <div className="mx-auto max-w-screen-xl text-center">
            ...
            <p className="my-6 text-gray-500 dark:text-gray-400">Discover the Beauty of Handmade, the Essence of Ethical Shopping, and the Joy of Owning Unique
