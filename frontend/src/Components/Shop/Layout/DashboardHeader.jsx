...
const DashboardHeader = () => {
    ...
    return (
        <div
            className="w-full h-[63px] md:h-[70px] bg-white shadow sticky top-0 left-0 z-30 flex items-center justify-between px-4 md:px-8">
            <Link to="/"
                  className=" w-[33%]"
            >
        <span
            className="text-md md:text-2xl font-bold bg-gradient-to-br from-purple-600 to-blue-500 text-transparent bg-clip-text">
          Artisan MarketPlace
        </span>
            </Link>
