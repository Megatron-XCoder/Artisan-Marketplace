...
import {GiMoneyStack, GiShop} from "react-icons/gi";
import {HiMiniShoppingCart} from "react-icons/hi2";
import Loader from "../Layout/Loader.jsx";
import {getAllShops, getAllUsers} from "../../redux/Actions/user.js";
...
const AdminDashboardMain = () => {
    ...
    if (productsLoading || adminOrderLoading) {
        return <Loader />;
    }
        ...
        <>
            {
                adminOrderLoading ? <Loader/> : (
                    <div className="w-full p-4 md:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <p className="text-gray-700 font-semibold text-md">Available Balance <span className={" inline-flex text-gray-500 font-normal text-sm"}>(Total earnings this month.)</span></p>
                                        <h3 className="text-2xl font-sans font-semibold">₹ {adminBalance}</h3>
                                    </div>
                                </div>
                                <Link
                                    to="/"
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <p className="text-gray-700 font-semibold text-md">All Orders</p>
                                        <h3 className="text-2xl font-semibold">{adminOrders && adminOrders.length}</h3>
                                    </div>
                                </div>
                                <Link
                                    to="/admin-orders"
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <p className="text-gray-700 font-semibold text-md">All Sellers</p>
                                        <h3 className="text-2xl font-semibold">{shops && shops.length}</h3>
                                    </div>
                                </div>
                                <Link
                                    to="/admin-sellers"
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="p-3 bg-pink-50 rounded-lg">
                                        <GiMoneyStack className="text-3xl text-pink-600" />
                                    </div>
                                    <div>
                                        <p className="text-gray-700 font-semibold text-md">All Products</p>
                                        <h3 className="text-2xl font-semibold">{allProducts && allProducts.length}</h3>
                                    </div>
                                </div>
                                <Link
                                    to="/admin-products"
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="p-3 bg-yellow-50 rounded-lg">
                                        <BsFillPeopleFill className="text-3xl text-yellow-400" />
                                    </div>
                                    <div>
                                        <p className="text-gray-700 font-semibold text-md">All Users</p>
                                        <h3 className="text-2xl font-semibold">{users?.length || 0}</h3>
                                    </div>
                                </div>
                                <Link
                                    to="/admin-users"
                        ...
                        <div className="bg-white md:h-[34vh] rounded-2xl md:overflow-y-scroll shadow-sm border border-gray-100">
                            ...
                            <div className="w-full mb-4 md:px-8 pt-1">
                                ...
                                <div className="hidden sm:grid grid-cols-6 gap-4 bg-gray-50 p-5 border-b font-medium text-gray-500 text-sm rounded-t-xl shadow-sm">
                                    ...
                                    <div className="min-w-[120px]">Created Date & Time</div>
                                </div>
                                    ...
                                    {adminOrders?.length === 0 ? (
                                        ...
                                        adminOrders?.map((order) => (
                                            ...
                                            >
                                                ...
                                                {/* Total */}
                                                <div className="sm:min-w-[90px] text-gray-900 font-sans">
                                                ...
                                                {/* Date & Time */}
                                                <div className="sm:min-w-[120px] text-gray-500">
                                                    <span className="sm:hidden mr-2 text-gray-600 font-medium">Date:</span>
