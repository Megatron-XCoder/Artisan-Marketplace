...
const Signup = () => {
    ...
    return (
        <section
            className="min-h-screen py-10 flex flex-col items-center justify-center bg-gradient-to-bl from-violet-600 to-fuchsia-400 dark:from-violet-700 dark:to-fuchsia-500 px-4">
