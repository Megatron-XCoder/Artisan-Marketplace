        ...
        <div className="mb-6">
          ...
          {select === 1 && (
              <div className="space-y-4 border-t pt-4">
                ...
                <button className="w-full bg-gradient-to-br from-purple-600 to-blue-500 text-white py-3 rounded-lg hover:opacity-90 transition-opacity font-medium">
                  Pay $256.00
                </button>
              </div>
          )}
        ...
        <div className="mb-6">
          ...
          {select === 2 && (
              <div className="border-t pt-4 space-y-4">
                <button className="w-full bg-gradient-to-tr from-purple-600 to-blue-500 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium">
        ...
        <div className="mb-6">
          ...
          {select === 4 && (
              <div className="border-t pt-4">
                <button className="w-full bg-gradient-to-tr from-purple-600 to-blue-500 text-white py-3 rounded-lg hover:opacity-90 transition-opacity font-medium">
                  Confirm Order
                </button>
              </div>
          )}
