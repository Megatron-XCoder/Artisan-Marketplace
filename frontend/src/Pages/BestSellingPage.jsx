...
const BestSellingPage = () => {
  ...
  const currentProducts = data && data.slice(0, indexOfLastProduct);
      ...
      <>
        <div>
          ...
          <div className={`${styles.section} mb-4`}>
            ...
            <div
                className="grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-4 lg:gap-[25px] xl:grid-cols-5 xl:gap-[30px] ">
              {currentProducts && currentProducts.map((i, index) => (
            ...
            {currentProducts && data && currentProducts.length < data.length && (
