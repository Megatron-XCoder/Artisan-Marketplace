const Styles = {
    ...
    productTitle: 'text-3xl font-bold text-[#333]',
    ...
    shop_name: "pt-3 text-[15px] text-blue-400 ",
    active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'w-[150px] bg-gradient-to-r from-purple-600 to-blue-500 h-[50px] hover:shadow-xl hover:scale-105 transition my-3 flex items-center justify-center rounded-xl cursor-pointer',
