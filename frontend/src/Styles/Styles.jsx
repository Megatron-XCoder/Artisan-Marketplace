const Styles = {
    ...
    button: 'w-[150px] bg-gradient-to-r from-purple-600 to-blue-500 h-[45px] hover:shadow-xl hover:scale-105 transition my-3 flex items-center justify-center rounded-lg cursor-pointer',
